...
public class CustomerAccountViewIntegrationTest {
    ...
    public void testViewCustomerAccountDetails() {
        ...
        Customer customer2 = customerManager.getCustomerById(customer.getCustomerId());
        assertNotNull(customer2, "Customer should exist in database");
        ...
        List<Account> customerAccounts = accountManager.getAccountsByCustomerId(customer2.getCustomerId());
        ...
        assertAll("Account details verification",
            ...
            () -> assertEquals(customer2.getCustomerId(), retrievedAccount.getCustomerId())
        );
    }
}